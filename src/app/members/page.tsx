    ...
    <div className="mx-auto max-w-content px-6 py-16 pb-20">
      ...
      <section className="mt-16 rounded-card border border-border bg-surface p-5 shadow-card">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <a className="rounded-control bg-surface-subtle p-3 text-sm font-semibold text-primary hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary" href={members[0] ? `/members/${members[0].slug}` : "/signup"}>{members[0] ? "View a member profile." : "Become the first listed member."}</a>
        </div>
      </section>
    </div>
  );
